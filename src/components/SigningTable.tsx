...
import {
  Send, Clock, CheckCircle, XCircle, Eye, Mail,
...
export default function SigningTable({ requests }: { requests: SigningRequest[] }) {
    ...
    <>
      ...
      <style jsx>{`
        ...
        .search-box {
          ...
          border-radius: var(--radius-md); flex: 1; max-width: 400px;
        }
        ...
        .requests-table th {
          padding: 16px 20px; text-align: left; background: #f8fafc;
          font-size: 13px; font-weight: 600; color: #64748b;
          border-bottom: 1px solid var(--border-color);
        }
        .requests-table td {
          padding: 16px 20px; border-bottom: 1px solid var(--border-color); font-size: 14px;
        }
        .requests-table tr:last-child td { border-bottom: none; }
        .recipient-info { display: flex; flex-direction: column; gap: 2px; }
        .recipient-info span { font-size: 12px; color: #64748b; }
        .status-badge {
