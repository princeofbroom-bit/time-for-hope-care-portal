...
export default function ClientDashboardView({ profileName }: { profileName: string }) {
  return (
    <>
      ...
      <style jsx>{`
        ...
        .welcome-section h2 { font-size: 32px; margin-bottom: 8px; color: var(--primary-color); }
        ...
        .stat-content h3 { font-size: 14px; color: #64748b; margin-bottom: 8px; font-weight: 500; }
        .stat-number { font-size: 28px; font-weight: 700; color: var(--primary-color); margin-bottom: 4px; }
        .stat-label { font-size: 13px; color: #94a3b8; }
        .actions-section, .activity-section { margin-bottom: 40px; }
        .actions-section h3, .activity-section h3 { font-size: 20px; margin-bottom: 20px; color: var(--primary-color); }
        .action-cards {
        ...
        .action-card:not(.disabled):hover {
          transform: translateY(-4px); box-shadow: var(--shadow-lg); border: 2px solid var(--secondary-color);
        }
        .action-card.disabled { opacity: 0.6; cursor: not-allowed; }
        .action-card h4 { margin: 16px 0 8px; font-size: 18px; color: var(--primary-color); }
        .action-card p { color: #64748b; font-size: 14px; }
        .coming-soon {
          position: absolute; top: 12px; right: 12px; background: var(--secondary-color);
          color: white; padding: 4px 8px; border-radius: var(--radius-sm); font-size: 11px; font-weight: 600;
        }
        .activity-list {
          background: white; border-radius: var(--radius-lg); box-shadow: var(--shadow-sm); overflow: hidden;
        }
        .activity-item {
          display: flex; gap: 16px; padding: 20px 24px; border-bottom: 1px solid var(--border-color);
        }
        ...
        .activity-content p { margin-bottom: 4px; color: var(--primary-color); }
