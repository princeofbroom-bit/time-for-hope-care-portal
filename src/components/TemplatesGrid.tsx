...
export default function TemplatesGrid({ templates }: { templates: DocumentTemplate[] }) {
  ...
  return (
    <>
      ...
      <style jsx>{`
        ...
        .banner-content h1 { font-size: 32px; margin-bottom: 8px; }
        .banner-content p { color: #64748b; }
        .btn-primary {
        ...
        .template-card {
          ...
          border: 1px solid var(--border-color); padding: 24px; transition: all 0.2s;
        }
        .template-card:hover { box-shadow: var(--shadow-md); border-color: var(--primary-color); }
        .template-header {
        ...
        .template-name { font-size: 18px; margin-bottom: 8px; }
        .template-description { color: #64748b; font-size: 14px; line-height: 1.5; margin-bottom: 16px; }
        .template-meta {
          display: flex; justify-content: space-between; align-items: center;
          padding-top: 16px; border-top: 1px solid var(--border-color); margin-bottom: 16px;
        }
        .template-type { font-size: 12px; color: #64748b; }
        .status-indicator { font-size: 11px; font-weight: 600; padding: 4px 8px; border-radius: 4px; }
        ...
        .add-card {
          ...
          min-height: 280px; border: 2px dashed var(--border-color); cursor: pointer; color: #64748b;
        }
        ...
        .modal-content h2 { font-size: 24px; margin-bottom: 24px; }
        ...
        .file-upload {
          ...
          padding: 32px; text-align: center; color: #64748b; cursor: pointer; position: relative;
        }
        .file-upload:hover { border-color: var(--primary-color); }
        .file-upload input { position: absolute; inset: 0; opacity: 0; cursor: pointer; }
        .file-upload p { margin-top: 8px; font-size: 14px; }
        .modal-actions { display: flex; gap: 12px; justify-content: flex-end; margin-top: 8px; }
        .btn-secondary {
          padding: 12px 20px; background: white; border: 1px solid var(--border-color);
