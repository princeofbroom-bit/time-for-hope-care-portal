  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setPendingDocs([
        {
          ...
          description: "NDIS service agreement between provider and participant",
          status: "pending",
        ...
        },
        {
          ...
          description: "General consent for services and data collection",
          status: "viewed",
      ...
      setSignedDocs([
        {
          id: "1",
          template_name: "Privacy Policy Agreement",
          signed_at: "2024-01-10T14:30:00Z",
          valid_until: "2025-01-10T14:30:00Z",
          download_url: "/api/documents/signed/1/download",
        },
        {
          id: "2",
          template_name: "Initial Assessment Form",
          signed_at: "2024-01-05T11:00:00Z",
          valid_until: null,
          download_url: "/api/documents/signed/2/download",
        },
      ]);
